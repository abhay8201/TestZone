...
<html lang="en" ">
  ...
  <head>
    ...
    <meta name="keywords" content="online test, test performance, take exam,give exam,online test series,online test practice,online test practice free ,online test practice mcq,generate test,generate test paper, secure test,generate exam online,create test online for student,create rtest for anybody,generate quiz online, create quiz,make test online for students,create test online on google form,secured data ,quiz with google form,test your idea,generate question for couligue,google form,test google form,create quiz with google form,quiz with google form, quiz with test zone , testzone, test, exam , examination,testzone for quiz ,testzone for test, teacher dashboard, test scheduling, TestZone, online exams, student tracking">
    <meta name="author" content="">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700,800,900" rel="stylesheet">

    <title>TestZone - Online Test Platform for Students & Teachers.</title>
  ...
  <section class="section coming-soon" id="connected_to">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-5" style="min-width: 318px;">
          <div class="continer centerIt">
